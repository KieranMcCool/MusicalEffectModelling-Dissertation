...
can take the form of simple tweaks to the frequency range of the track
to applying pitch modulation and beyond.
...
stacked convolutional layers applying dilated casual convolutions.
\autocite{van2016wavenet} At each layer they would double the dilation
amount up to a maximum before starting again at 1. This a increases the
receptive field of the network in a similar way to how an LSTM
selectively remembers traits while maintaining the ease of training of a
...
properties to remember and for how long \autocite{gers1999learning}.
...
Reaper signal chain file to be given to be applied to each of these
