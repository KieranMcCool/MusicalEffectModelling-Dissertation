...
\ref{fig:distortionsm}, and ({\textbf{???}}), the distortion unit adds a
huge amount to the intensity of all frequencies, with a bias toward the
mid ranges. This behaviour is captured fairly well by the model. Figure
\ref{fig:distortion} also demonstrates that the amplitude boost is also
...
\begin{figure}
\centering
\includegraphics[width=6.00000in]{images/distclean.png}
\caption{Clean Spectogram\label{fig:distortionsc}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=6.00000in]{images/distmodel.png}
\caption{Model Spectogram\label{fig:distortionsm}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=6.00000in]{images/distvstspect.png}
\caption{VST Spectogram\label{fig:distortionsv}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=6.00000in,height=4.50000in]{images/distortion.png}
\caption{Distortion Impulse Response after 30000 iterations over the
dataset\label{fig:distortion}}
\end{figure}
