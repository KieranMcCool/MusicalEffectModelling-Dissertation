...
While the spectogram (Figures ({\textbf{???}}), ({\textbf{???}}), and
({\textbf{???}})) seems to confirm that some aspects of the EQ profile
are learned, it fails to match as closely as the previous effects.
Beyond this, the VST seems to add a lot more gain, as demonstrated in
...
\begin{figure}
\centering
\includegraphics[width=3.00000in]{images/pitchvst.png}
