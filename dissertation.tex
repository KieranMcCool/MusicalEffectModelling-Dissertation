...
\caption{Clean Spectogram\label{fig:fuzzc}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=4.00000in]{images/fuzzmodel.png}
\caption{Model Spectogram\label{fig:fuzzm}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=4.00000in]{images/fuzzvst.png}
\caption{VST Spectogram\label{fig:fuzzv}}
\end{figure}
...
\caption{Clean Spectogram\label{fig:ampc}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=4.00000in]{images/ampsimmodel.png}
\caption{Model Spectogram\label{fig:ampm}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=4.00000in]{images/ampsimvst.png}
\caption{VST Spectogram\label{fig:ampv}}
\end{figure}
